...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-226">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/226</gml:identifier>
  <gml:name>ITRF2014 - LatLonEHt</gml:name>
  <gml:remarks>Replaces ITRF2008 - LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-175">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/175</gml:identifier>
      <gml:name>International Terrestrial Reference Frame 2014</gml:name>
      <gml:remarks>Replaces ITRF2008.
...
GRS80 is the ellipsoid recommended by the IAG and IERS.</gml:remarks>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realisation of the IERS Terrestrial Reference System (ITRS) at reference epoch 2010.0.
Origin is defined such that there are zero translation parameters at epoch 2010.0 and zero translation rates between the ITRF2014 and the ILRS SLR long-term solution obtained by tacking the ILRS time series.
Scale is defined such that there are zero scale and scale rate between ITRF2014 and the average of VLBI and SLR scales/rates.
Orientation is defined such that there are zero rotation parameters at epoch 2010.0 and zero rotation rates between the ITRF2014 and ITRF2008.
Datum defined by a set of 3 dimensional Cartesian station coordinates, velocities, annual and semi-annual terms, and post-seismic deformation models given by the citations.</gml:anchorDefinition>
      <gml:realizationEpoch>2016-01-22</gml:realizationEpoch>
      <gml:primeMeridian>
