...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-454">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/454</gml:identifier>
  <gml:name>SIRGAS-CON DGF00P01 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-133">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/133</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network DGF00P01</gml:name>
      <gml:remarks>DGF00P01 is included in ITRF2000 as a regional densification for South America. Replaces SIRGAS2000 for continuous stations in some SIRGAS countries. Replaced by DGF01P01.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 31 continuously operating stations using GPS observations from June 1996 to February 2000 and aligned to ITRF97 at epoch 2000.4. Velocity model VEMOS2003 used to propagate coordinates from an arbitrary epoch to the 2000.4 reference epoch.</gml:anchorDefinition>
