...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-399">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/399</gml:identifier>
  <gml:name>SIRGAS-CON SIR13P01 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-177">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/177</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network SIR13P01</gml:name>
      <gml:remarks>Replaces SIR11P01. Replaced by SIR14P01. First multi-year solution after the El Maule earthquake of February 2010.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 108 continuously operating stations using GPS observations from April 2010 to June 2013 and aligned to IGb08 at epoch 2012.0. Weekly normal equations from April 2010 to April 2011 were reprocessed using the second reprocessing campaign products (IG2) of the International GNSS Service and absolute phase centre calibrations referring to the IGS08 reference frame. Velocity model VEMOS2009 used to propagate coordinates from an arbitrary epoch to the 2012.0 reference epoch.</gml:anchorDefinition>
