...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-451">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/451</gml:identifier>
  <gml:name>SIRGAS-CON SIR09P01 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-181">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/181</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network SIR09P01</gml:name>
      <gml:remarks>Replaces DGF08P01. Replaced by SIR10P01.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 128 continuously operating stations using GPS observations from January 2000 to January 2009 and aligned to IGS05 at epoch 2005.0. GPS data from January 2000 to November 2006 reprocessed using the first reprocessing campaign products (IG1) of the International GNSS Service and absolute phase centre calibrations referring to the IGS05/IGb05 reference frame. Velocity model VEMOS2009 used to propagate coordinates from an arbitrary epoch to the 2005.0 reference epoch.</gml:anchorDefinition>
      <gml:realizationEpoch>2009</gml:realizationEpoch>
      <gml:primeMeridian>
