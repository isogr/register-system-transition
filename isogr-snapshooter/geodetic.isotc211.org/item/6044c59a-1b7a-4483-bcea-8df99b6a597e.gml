...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-453">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/453</gml:identifier>
  <gml:name>IGS05 - LatLonEHt</gml:name>
  <gml:remarks>Replaces IGb00 - LatLonEHt. Replaced by IGS08 - LatLonEHt. Used by IGS products within the period 2006-11-05 thru 2011-04-16.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-202">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/202</gml:identifier>
      <gml:name>IGS05</gml:name>
      <gml:remarks>Replaces IGb00. Replaced by IGS08. Used by IGS products within the period 2006-11-05 thru 2011-04-16.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial Referencing</gml:scope>
      <gml:anchorDefinition>Derived from and aligned to a subset of 139 stable IGS station coordinates and velocities in ITRF2005 at epoch 2000.0.
The first IGS reference frame to use absolute antenna phase calibrations for both ground stations and satellite antennas.</gml:anchorDefinition>
      <gml:realizationEpoch>2006-11-05</gml:realizationEpoch>
      <gml:primeMeridian>
