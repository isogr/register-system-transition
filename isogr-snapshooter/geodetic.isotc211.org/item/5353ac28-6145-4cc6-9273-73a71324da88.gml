...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-363">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/363</gml:identifier>
  <gml:name>SIRGAS-CON DGF01P01 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-173">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/173</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network DGF01P01</gml:name>
      <gml:remarks>Replaces DGF00P01. Replaced by DGF01P02.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 48 continuously operating stations using GPS observations from June 1996 to April 2001 and aligned to ITRF2000 at epoch 2000.0. Velocity model VEMOS2003 used to propagate coordinates from an arbitrary epoch to the 2000.0 reference epoch.</gml:anchorDefinition>
