...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-354">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/354</gml:identifier>
  <gml:name>NAD 83 (CORS96) Epoch 2002.0 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-112">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/112</gml:identifier>
      <gml:name>North American Datum of 1983 (CORS96) Epoch 2002.0</gml:name>
      <gml:remarks>Replaces NAD83 (CORS96) Epoch 1997.0. Replaced by NAD83(2011), NAD83 (MA11) and NAD83 (PA11) from 2011-09-06. </gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realization of the NAD83. The frame is defined by a time-dependent seven parameter transformation of ITRF2000 3D geocentric Cartesian coordinates and velocities at reference epoch 2002.0. The frame is kept aligned to North America at other epochs using the NNR-NUVEL-1A estimate of three Cartesian rotation rates of change representing the tectonic plate motion of North America. The origin, scale and orientation of the frame are nominally defined to be that for the BIH Terrestrial System 1984 (BTS84). Passive control  network from NAD83 (2007) was a densification of the NAD83 (CORS96) Epoch 2002 for the active control network, but that they are functionally equivalent.</gml:anchorDefinition>
      <gml:realizationEpoch>2002</gml:realizationEpoch>
      <gml:primeMeridian>
