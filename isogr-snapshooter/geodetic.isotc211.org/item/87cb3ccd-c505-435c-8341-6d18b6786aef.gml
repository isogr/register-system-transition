...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-361">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/361</gml:identifier>
  <gml:name>ITRF89 - LatLonEHt</gml:name>
  <gml:remarks>Replaces ITRF88  - LatLonEHt. Replaced by ITRF90 - LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-192">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/192</gml:identifier>
      <gml:name>International Terrestrial Reference Frame 1989</gml:name>
      <gml:remarks>Replaces ITRF88. Replaced by ITRF90.
...
Orientation is defined such that no global rotation exists with respect to ITRF88.
...
Datum defined by a set of 3 dimensional Cartesian station coordinates given by the citations.</gml:anchorDefinition>
      <gml:realizationEpoch>1991-04-01</gml:realizationEpoch>
      <gml:primeMeridian>
