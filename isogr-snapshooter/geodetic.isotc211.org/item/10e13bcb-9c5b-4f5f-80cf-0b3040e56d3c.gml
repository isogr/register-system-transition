...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-312">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/312</gml:identifier>
  <gml:name>SIRGAS-CON SIR17P01 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-129">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/129</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network SIR17P01</gml:name>
      <gml:remarks>Replaces SIR15P01.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 345 continuously operating stations using GPS and GLONASS observations from April 2011 to January 2017 and aligned to IGS14 at epoch 2015.0. This cumulative solution has been made consistent with the phase centre calibrations referring to the IGS14 reference frame using the latitude-dependent phase centre correction model by the International GNSS Service. Velocity model VEMOS2017 used to propagate coordinates from an arbitrary epoch to the 2015.0 reference epoch.</gml:anchorDefinition>
      <gml:realizationEpoch>2018</gml:realizationEpoch>
      <gml:primeMeridian>
