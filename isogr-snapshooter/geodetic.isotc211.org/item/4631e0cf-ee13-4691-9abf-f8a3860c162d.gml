...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-232">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/232</gml:identifier>
  <gml:name>SIRGAS-CON DGF08P01 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-184">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/184</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network DGF08P01</gml:name>
      <gml:remarks>Replaces DGF07P01. Replaced by SIR09P01.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 126 continuously operating stations using GPS observations from December 2002 to March 2008 and aligned to IGS05 at epoch 2004.5. GPS data from December 2002 to November 2006 reprocessed using the first reprocessing campaign products (IG1) of the International GNSS Service and absolute phase centre calibrations referring to the IGS05/IGb05 reference frame. Velocity model VEMOS2003 used to propagate coordinates from an arbitrary epoch to the 2004.5 reference epoch.</gml:anchorDefinition>
