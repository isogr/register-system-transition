...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-327">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/327</gml:identifier>
  <gml:name>NAD83(CSRS) v6 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-183">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/183</gml:identifier>
      <gml:name>North American Datum of 1983 (CSRS) version 6</gml:name>
      <gml:remarks>Adopted by the Canadian federal government for Canada, and by provincial governments in Manitoba, Newfoundland and Labrador, Nova Scotia, Ontario, and Prince Edward Island. Replaces NAD83(CSRS) v5. Replaced by NAD83(CSRS) v7.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:realizationEpoch>2010-01-01</gml:realizationEpoch>
      <gml:primeMeridian>
