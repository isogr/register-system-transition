...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-286">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/286</gml:identifier>
  <gml:name>ITRF92 - LatLonEHt</gml:name>
  <gml:remarks>Replaces ITRF91 - LatLonEHt. Replaced by ITRF93 - LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-103">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/103</gml:identifier>
      <gml:name>International Terrestrial Reference Frame 1992</gml:name>
      <gml:remarks>Replaces ITRF91. Replaced by ITRF93.
...
Scale is defined by SLR noting that the scales of most VLBI Solutions are consistent with SLR.
Orientation is defined such that no global rotation exists with respect to ITRF91.
In order to insure the condition of no-net-rotation of the ITRS orientation with respect to the Earth&amp;apos;s crust, NNR-NUVEL1 was selected as the reference motion model as recommended by the IERS Conventions (1992) (McCarthy, 1992).
Datum defined by a set of 3 dimensional Cartesian station coordinates and velocities given in the citations.
The ITRF92 velocity field has been obtained by combination of eight site velocity fields estimated by SLR and VLBI analysis centers.</gml:anchorDefinition>
      <gml:realizationEpoch>1993-10-01</gml:realizationEpoch>
      <gml:primeMeridian>
