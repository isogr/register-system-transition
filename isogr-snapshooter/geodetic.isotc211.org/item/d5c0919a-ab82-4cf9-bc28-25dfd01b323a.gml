...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-459">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/459</gml:identifier>
  <gml:name>IGS00 - LatLonEHt</gml:name>
  <gml:remarks>Replaces IGS97 - LatLonEHt. Replaced by IGb00 - LatLonEHt. Used by IGS products within the period 2001-12-02 thru 2004-01-10.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-194">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/194</gml:identifier>
      <gml:name>IGS00</gml:name>
      <gml:remarks>Replaces IGS97. Replaced by IGb00. Used by IGS products within the period 2001-12-02 thru 2004-01-10.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial Referencing</gml:scope>
      <gml:anchorDefinition>Defined from and aligned to a subset of 54 stable IGS station coordinates and velocities in ITRF2000 at epoch 1998.0.
Uses relative antenna phase calibrations for ground stations and no calibrations for satellite antennas.</gml:anchorDefinition>
      <gml:realizationEpoch>2001-12-02</gml:realizationEpoch>
      <gml:primeMeridian>
