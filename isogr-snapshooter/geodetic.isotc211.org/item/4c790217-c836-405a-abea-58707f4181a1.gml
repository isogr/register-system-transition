...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-223">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/223</gml:identifier>
  <gml:name>SIRGAS-CON DGF06P01 - LatLon</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-124">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/124</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network DGF06P01</gml:name>
      <gml:remarks>Replaces DGF05P01. Replaced by DGF07P01.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 94 continuously operating stations using GPS observations from June 1996 to June 2006 and aligned to ITRF2000 at epoch 2004.0. Velocity model VEMOS2003 used to propagate coordinates from an arbitrary epoch to the 2004.0 reference epoch.</gml:anchorDefinition>
      <gml:realizationEpoch>2006</gml:realizationEpoch>
      <gml:primeMeridian>
