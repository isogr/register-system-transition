...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-797">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/797</gml:identifier>
  <gml:name>WGS 84 (G2139) - LatLonEHt</gml:name>
  <gml:remarks>Replaces WGS 84 (G1762) - LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-795">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/795</gml:identifier>
      <gml:name>World Geodetic System 1984 (G2139)</gml:name>
      <gml:remarks>From 2021-01-03 replaces World Geodetic System 1984 (G1762), which has been redesignated World  Geodetic System 1984 (G1762'). Tracking station coordinates changed on 2021-03-28 when NGA implemented the IGS definition of GPS satellite antenna phase centre offsets.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing and GPS satellite navigation</gml:scope>
      <gml:anchorDefinition>Defined through coordinates of 19 GPS tracking stations aligned to a subset of IGb14 stations at epoch 2016.0. The IGb14 station coordinates are considered to be equivalent to ITRF2014.</gml:anchorDefinition>
      <gml:realizationEpoch>2021-01-03</gml:realizationEpoch>
      <gml:primeMeridian>
