...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-355">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/355</gml:identifier>
  <gml:name>ITRF2000 - LatLonEHt</gml:name>
  <gml:remarks>Replaces ITRF97 - LatLonEHt . Replaced by ITRF2005 - LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-165">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/165</gml:identifier>
      <gml:name>International Terrestrial Reference Frame 2000</gml:name>
      <gml:remarks>Replaces ITRF97. Replaced by ITRF2005.
...
Origin is defined by satellite laser ranging (SLR).
Scale is defined by SLR and very long baseline interferometry.
Orientation is aligned to the ITRF97 at epoch 1997.0, and its time evolution follows that of the no-net-rotation NNR-NUVEL-1A geophysical model.
