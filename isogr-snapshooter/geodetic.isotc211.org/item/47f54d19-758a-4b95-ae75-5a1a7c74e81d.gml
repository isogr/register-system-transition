...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-375">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/375</gml:identifier>
  <gml:name>NAD83(CSRS) v3 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-123">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/123</gml:identifier>
      <gml:name>North American Datum of 1983 (CSRS) version 3</gml:name>
      <gml:remarks>Adopted by the Canadian federal government for use in Canada, and by provincial governments in British Columbia, Nova Scotia and Ontario. Replaces NAD83(CSRS) v2. Replaced by NAD83(CSRS) v4.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
