...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-282">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/282</gml:identifier>
  <gml:name>ITRF90 - LatLonEHt</gml:name>
  <gml:remarks>Replaces ITRF89 - LatLonEHt. Replaced by ITRF91 - LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-99">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/99</gml:identifier>
      <gml:name>International Terrestrial Reference Frame 1990</gml:name>
      <gml:remarks>Replaces ITRF89. Replaced by ITRF91.
...
Scale is defined by SLR noting that the VLBI scale (GSFC and NGS) is consistent with SLR.
Orientation is defined such that no global rotation exists with respect to ITRF89.
...
Datum defined by a set of 3 dimensional Cartesian station coordinates given by the citations.</gml:anchorDefinition>
      <gml:realizationEpoch>1991-12-01</gml:realizationEpoch>
      <gml:primeMeridian>
