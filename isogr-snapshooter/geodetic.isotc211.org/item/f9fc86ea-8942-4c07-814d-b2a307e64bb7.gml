...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-747">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/747</gml:identifier>
  <gml:name>ETRF2014 - LatLonEHt</gml:name>
  <gml:remarks>The EUREF Governing Board recommends to use the ETRF2014 for high precision applications and better consistency with the ITRF2014 precise geocentric origin.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-745">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/745</gml:identifier>
      <gml:name>European Terrestrial Reference Frame 2014</gml:name>
      <gml:remarks>The EUREF Technical Working Group (TWG) recommends to use the ETRF2014 for high precision applications and better consistency with the ITRF2014 precise geocentric origin.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Coincides with ITRF2014 at epoch 1989.0 and is fixed to the stable part of the Eurasian tectonic plate through 3 rotation rates derived from the ITRF2014 velocity field, representing the Eurasian plate’s angular velocity about its Euler pole.</gml:anchorDefinition>
      <gml:realizationEpoch>2017-11-16</gml:realizationEpoch>
      <gml:primeMeridian>
