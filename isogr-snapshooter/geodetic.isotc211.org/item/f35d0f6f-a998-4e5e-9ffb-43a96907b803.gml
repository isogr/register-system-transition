...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-203">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/203</gml:identifier>
  <gml:name>SIRGAS-CON SIR14P01 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-189">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/189</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network SIR14P01</gml:name>
      <gml:remarks>Replaces SIR13P01. Replaced by SIR15P01.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 242 continuously operating stations using GPS and GLONASS observations from April 2010 to July 2014 and aligned to IGb08 at epoch 2013.0. Weekly normal equations from April 2010 to April 2011 were reprocessed using the second reprocessing campaign products (IG2) of the International GNSS Service and absolute phase centre calibrations referring to the IGS08 reference frame. Velocity model VEMOS2009 used to propagate coordinates from an arbitrary epoch to the 2013.0 reference epoch.</gml:anchorDefinition>
      <gml:realizationEpoch>2014</gml:realizationEpoch>
      <gml:primeMeridian>
