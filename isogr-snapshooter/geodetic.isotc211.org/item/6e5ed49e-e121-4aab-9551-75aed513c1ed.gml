...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-981">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/981</gml:identifier>
  <gml:name>IGS20 - LatLonEHt</gml:name>
  <gml:remarks>Replaces IGb14 - LatLonEHt. Used by IGS products from 2022-11-27. An updated set of satellite and ground antenna calibrations defined in igs20.atx and post-seismic deformation models defined in psd_IGS20.snx must be used together with IGS20.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-979">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/979</gml:identifier>
      <gml:name>IGS20</gml:name>
      <gml:remarks>Replaces IGb14. Used by IGS products from 2022-11-27. An updated set of satellite and ground antenna calibrations defined in igs20.atx and post-seismic deformation models defined in psd_IGS20.snx must be used together with IGS20.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Derived from a long-term combination of daily IGS repro3 solutions from 1994 to 2020 and aligned in origin, scale and orientation and their rates of change to ITRF2020 at epoch 2015.0 via a subset of 332 stable, well performing IGS stations.</gml:anchorDefinition>
