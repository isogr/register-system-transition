...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-264">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/264</gml:identifier>
  <gml:name>ITRF94 - LatLonEHt</gml:name>
  <gml:remarks>Replaces ITRF93 - LatLonEHt. Replaced by ITRF96 -LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-197">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/197</gml:identifier>
      <gml:name>International Terrestrial Reference Frame 1994</gml:name>
      <gml:remarks>Replaces ITRF93. Replaced by ITRF96.
...
Origin is defined by a weighted average of a selection of SLR and GPS solutions.
Scale is defined by a weighted average of a selection of VLBI, SLR and GPS solutions, modified in order to take into account the fact that the solutions use TAI and not TCG as a time scale.
Orientation is consistent with ITRF92 (not ITRF93) at epoch 1988.0 and its time evolution follows the geophysical model NNR-NUVEL1A.
Datum defined by a set of 3 dimensional Cartesian station coordinates and velocities given in the citations.</gml:anchorDefinition>
      <gml:realizationEpoch>1996-03-01</gml:realizationEpoch>
      <gml:primeMeridian>
