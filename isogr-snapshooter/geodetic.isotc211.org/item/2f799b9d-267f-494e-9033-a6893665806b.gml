...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-313">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/313</gml:identifier>
  <gml:name>SIRGAS2000 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-169">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/169</gml:identifier>
      <gml:name>Sistema de Referencia Geocentrico para America del Sur 2000</gml:name>
      <gml:remarks>Name changed from &quot;South American Geocentric Reference System&quot; to &quot;Geocentric Reference System of the Americas&quot; in 2001. Replaces SIRGAS95. Replaced by DGF00P01 for continuous stations in some SIRGAS countries.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 184 continuously operating and campaign stations using GPS observations from ten days in May 2000 and aligned to ITRF2000 at epoch 2000.4. Velocity model VEMOS2003 used to propagate coordinates from an arbitrary epoch to the 2000.4 reference epoch.</gml:anchorDefinition>
      <gml:realizationEpoch>2005</gml:realizationEpoch>
      <gml:primeMeridian>
