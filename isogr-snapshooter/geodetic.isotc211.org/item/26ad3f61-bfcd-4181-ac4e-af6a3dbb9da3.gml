...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-786">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/786</gml:identifier>
  <gml:name>ATRF2014 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-783">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/783</gml:identifier>
      <gml:name>Australian Terrestrial Reference Frame 2014</gml:name>
      <gml:remarks>Densification of ITRF2014 in the Australian region.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>ATRF2014 is aligned to ITRF2014 at epoch 2020.0. Horizontal velocities from the Australian Plate Motion Model are used to propagate the horizontal coordinates to any other desired epoch.</gml:anchorDefinition>
