...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-217">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/217</gml:identifier>
  <gml:name>ETRF89 - LatLonEHt</gml:name>
  <gml:remarks>The distinction in usage between ETRF89 and ETRS89 is confused: although in principle conceptually different in practice both are used as synonyms.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-128">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/128</gml:identifier>
      <gml:name>European Terrestrial Reference Frame 1989</gml:name>
      <gml:remarks>ETRS89 is the reference system and ETRF89 is its first realization. Unfortunately the two terms have been used synonymously, which has caused some confusion amongst users. The reference frame should be referred to as ETRF89 to distinguish it from other realizations of ETRS89.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Coincides with ITRF89 at epoch 1989.0 and is fixed to the stable part of the Eurasian tectonic plate through 3 rotation rates derived from the AM02 geophysical model, representing the Eurasian plate’s angular velocity about its Euler pole.</gml:anchorDefinition>
      <gml:realizationEpoch>1990</gml:realizationEpoch>
      <gml:primeMeridian>
