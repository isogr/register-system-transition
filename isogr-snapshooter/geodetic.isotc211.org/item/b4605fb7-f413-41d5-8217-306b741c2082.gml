...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-299">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/299</gml:identifier>
  <gml:name>IGS14 - LatLonEHt</gml:name>
  <gml:remarks>Replaces IGb08 - LatLonEHt. Used by  IGS products from 2017-01-29.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-153">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/153</gml:identifier>
      <gml:name>IGS14</gml:name>
      <gml:remarks>Replaces IGb08. Replaced by IGb14. Used by IGS products from 2017-01-29 to 2020-05-17.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Derived from and aligned to a subset of stable, well-performing IGS station coordinates and velocities in ITRF2014 at epoch 2010.0 with position corrections applied to account for updated ground receiver antenna calibrations. Use of IGS14 requires the use of the updated ground and satellite antenna calibrations (igs14.atx) and post-seismic deformation models (psd_IGS14.snx).</gml:anchorDefinition>
      <gml:realizationEpoch>2017-01-29</gml:realizationEpoch>
      <gml:primeMeridian>
