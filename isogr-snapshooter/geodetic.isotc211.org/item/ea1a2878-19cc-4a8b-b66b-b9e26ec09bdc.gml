...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-271">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/271</gml:identifier>
  <gml:name>SIRGAS-CON DGF07P01 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-98">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/98</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network DGF07P01</gml:name>
      <gml:remarks>Replaces DGF06P01. Replaced by DGF08P01.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 106 continuously operating stations using GPS observations from December 2001 to December 2002,  January to May 2005 and January 2006 to October 2007, and aligned to IGS05 at epoch 2004.5. Based on reprocessed weekly normal equations using the first reprocessing campaign products (IG1) of the International GNSS Service and absolute phase centre calibrations referring to the IGS05/IGb05 reference frame. Velocity model VEMOS2003 used to propagate coordinates from an arbitrary epoch to the 2004.5 reference epoch.</gml:anchorDefinition>
      <gml:realizationEpoch>2007</gml:realizationEpoch>
      <gml:primeMeridian>
