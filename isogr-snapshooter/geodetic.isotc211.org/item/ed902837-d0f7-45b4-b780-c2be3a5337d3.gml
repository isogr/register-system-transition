...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-405">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/405</gml:identifier>
  <gml:name>WGS 84 (G1762) - LatLonEHt</gml:name>
  <gml:remarks>Replaces WGS 84 (G1674) - LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-131">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/131</gml:identifier>
      <gml:name>World Geodetic System 1984 (G1762)</gml:name>
      <gml:remarks>Replaces World Geodetic System 1984 (G1674) and used in broadcast and precise ephemerides from 2013-10-16. The reference frame was redesignated WGS 84 (G1762’) after coordinates of 7 NGA tracking stations were changed following station moves and antenna updates between 2014-08 and 2015-06. Replaced by WGS 84 (G2139) from 2021-01-03.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
