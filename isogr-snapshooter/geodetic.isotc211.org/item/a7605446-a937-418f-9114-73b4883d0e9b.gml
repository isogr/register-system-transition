...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-209">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/209</gml:identifier>
  <gml:name>ITRF2005 - LatLonEHt</gml:name>
  <gml:remarks>Replaces ITRF2000 - LatLonEHt. Replaced by ITRF2008 - LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-105">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/105</gml:identifier>
      <gml:name>International Terrestrial Reference Frame 2005</gml:name>
      <gml:remarks>Replaces ITRF2000. Replaced by ITRF2008.
...
GRS80 is the ellipsoid recommended by the IAG and IERS.</gml:remarks>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realisation of the IERS Terrestrial Reference System (ITRS) at reference epoch 2000.0.
Origin at geocentre, originally orientated to the BIH Terrestrial System at epoch 1984.0 then adjusted to ensure zero net rotation to earth&amp;apos;s overall tectonic motion.
Origin is defined such that there are null translation parameters at epoch 2000.0 and null translation rates between the ITRF2005 and the ILRS SLR time series. 
Scale is defined such that there are null scale factor at epoch 2000.0 and null scale rate between the ITRF2005 and IVS VLBI time series. 
Orientation is defined such that there are null rotation parameters at epoch 2000.0 and null rotation rates between the ITRF2005 and ITRF2000.
Datum defined by a set of 3 dimensional Cartesian station coordinates and velocities given by the citations.</gml:anchorDefinition>
      <gml:realizationEpoch>2006-10-05</gml:realizationEpoch>
      <gml:primeMeridian>
