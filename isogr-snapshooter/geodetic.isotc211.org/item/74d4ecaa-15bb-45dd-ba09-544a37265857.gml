...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-303">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/303</gml:identifier>
  <gml:name>SIRGAS-CON SIR11P01 - LatLonEHt</gml:name>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-174">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/174</gml:identifier>
      <gml:name>SIRGAS Continuously Operating Network SIR11P01</gml:name>
      <gml:remarks>Replaces SIR10P01. Replaced by SIR13P01. Last multi-year solution without the effects of the El Maule earthquake in February 2010.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial referencing</gml:scope>
      <gml:anchorDefinition>Realized by a frame of 230 continuously operating stations using GPS observations from January 2000 to April 2011 and aligned to ITRF2008 at epoch 2005.0. GPS data from January 2000 to November 2006 reprocessed using the first reprocessing campaign products (IG1) of the International GNSS Service and absolute phase centre calibrations referring to the IGS05/IGb05 reference frame. Velocity model VEMOS2009 used to propagate coordinates from an arbitrary epoch to the 2005.0 reference epoch.</gml:anchorDefinition>
      <gml:realizationEpoch>2011</gml:realizationEpoch>
      <gml:primeMeridian>
