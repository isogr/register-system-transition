...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-233">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/233</gml:identifier>
  <gml:name>ITRF96 - LatLonEHt</gml:name>
  <gml:remarks>Replaces ITRF94 - LatLonEHt . Replaced by ITRF97 - LatLonEHt.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-146">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/146</gml:identifier>
      <gml:name>International Terrestrial Reference Frame 1996</gml:name>
      <gml:remarks>Replaces ITRF94. Replaced by ITRF97.
...
The origin, scale, orientation and its time evolution is achieved such that ITRF96 is in the same system as the ITRF94.
Datum defined by a set of 3 dimensional Cartesian station coordinates and velocities given by the citations.</gml:anchorDefinition>
      <gml:realizationEpoch>1998-05-01</gml:realizationEpoch>
      <gml:primeMeridian>
