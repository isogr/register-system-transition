...
<gml:GeodeticCRS xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="iso-crs-205">
  <gml:description/>
  <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/205</gml:identifier>
  <gml:name>IGS08 - LatLonEHt</gml:name>
  <gml:remarks>Replaced by IGb08 - LatLonEHt. Used by IGS products within the period 2011-04-17 thru 2012-10-06.</gml:remarks>
  ...
  <gml:geodeticDatum>
    <gml:GeodeticDatum gml:id="iso-datum-106">
      <gml:description/>
      <gml:identifier codeSpace="urn:ietf:rfc:1738">geodetic.isotc211.org/register/geodetic/items/106</gml:identifier>
      <gml:name>IGS08</gml:name>
      <gml:remarks>Replaces IGS05. Replaced by IGb08. Used by IGS products within the period 2011-04-17 thru 2012-10-06.</gml:remarks>
      <gml:domainOfValidity>
        <gmd:EX_Extent>
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
      ...
      <gml:scope>Spatial Referencing</gml:scope>
      <gml:anchorDefinition>Derived from and aligned to a subset of stable, well-performing IGS station coordinates and velocities in ITRF2008 at epoch 2005.0 with position corrections applied to account for updates to receiver antenna calibrations.
Uses updated absolute antenna calibrations for both ground stations and satellite antennas (igs08.atx).</gml:anchorDefinition>
      <gml:realizationEpoch>2011-04-17</gml:realizationEpoch>
      <gml:primeMeridian>
